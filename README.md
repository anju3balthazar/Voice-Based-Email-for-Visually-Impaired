# Voice-Enabled Email App for Visually Impaired
This Android application provides a user-friendly interface for visually impaired individuals to manage their emails using voice commands. The app aims to improve accessibility and efficiency in email communication for users with visual impairments.
# Key Features
1. Voice Command Recognition: The app uses speech recognition technology to interpret and execute voice commands for email management.
